...
class ActionExplorer:
    def action_connect():
        ...
        userName = read_yaml_by_key("dbaas_username")
        password = read_yaml_by_key("dbaas_password")
        ...
        login_info = InterfaceExplorer.interface_connect(data)
    ...
    #     a = {workflow_name : str(workflow_id)}
    #     print(a)
